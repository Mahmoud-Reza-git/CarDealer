<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logon.aspx.cs" Inherits="Automobile.Admin.Logon" %>
...
<body>
        ...
        <tr>
            ...
            <td style="width: 48%">             
                ...
                <fieldset class="form-group">
                    <input id="txtEmail1" maxlength="100" type="email" placeholder="Bitte geben Sie Ihre Email-Adresse ein " class="form-control" runat="server" />                   
                    <asp:Label ID="lblEmailLeer" runat="server" Text="Bitte geben Sie Ihre Email-Adresse ein " Visible="False" ForeColor="Red"></asp:Label>
                </fieldset>


                <fieldset class="form-group">
                    <input id="txtPass1" maxlength="100" class="form-control" type="password" placeholder="Bitte geben Sie Ihr Passwort ein" runat="server" />                    
                    <asp:Label ID="lblPassLeer" runat="server" Text="Bitte egeben Sie Ihr Passwort ein" Visible="False" ForeColor="Red"></asp:Label>
                </fieldset>

                <fieldset class="form-group">
                    <input id="txtPass2" maxlength="100" class="form-control" type="password" placeholder="Bitte geben Sie Ihr Passwort ein" runat="server"/>                   
                    <asp:Label ID="lblPassLeer2" runat="server" Text="Bitte geben Sie Ihr Passwort ein" Visible="False" ForeColor="Red"></asp:Label>
                </fieldset>
            ...
            <td style="width: 48%">
                ...
                <br />
                <fieldset class="form-group">
                    <input id="txtUserName" maxlength="100" placeholder="Bitte geben Sie Ihre Email-Adresse ein" type="text" class="form-control" runat="server"/>                    
                    <asp:Label ID="lblEmilAdresseLeer" runat="server" Text="Bitte geben Sie Ihre Email-Adresse ein!" Visible="False" ForeColor="Red"></asp:Label>
                </fieldset>

                <fieldset class="form-group">
                    <input id="txtUserPass" maxlength="100" placeholder="Bitte geben Sie Ihr Passwort ein" class="form-control" type="password" runat="server"/>                    
                    <asp:Label ID="lblPasswortLeer" runat="server" Text="Bitte geben Sie Ihr Passwort ein!" Visible="False" ForeColor="Red"></asp:Label>
                </fieldset>
                <fieldset class="form-group">
        ...
        <tr>
            <td style="width: 100%">
                <p style="text-align: center; word-spacing: normal; font-style: normal; font-size: small; font-weight: normal; color: #FF0000">
                    Wenn Sie Ihr Passwort vergessen haben, geben Sie bitte Ihre Email-Adresse ein. Sie erhalten von uns sofort eine Email mit einer temporären E-Mail-Adresse und einem temporären Passwort, damit Sie sich auf Ihrer Seite zur Passwortänderung in Logon anmelden können.
                </p>
            </td>
        </tr>
    </table>
    ...
    <table style="width: 100%; background-color: #CCFF99; text-align: center;">
        ...
        <tr>
            ...
            <td style="width: 40%">
                <input id="txtemailtoPass" maxlength="100" placeholder="Wenn Sie Ihr Passwort vergessen, geben Ihre Email-Adresse ein" class="form-control" type="email" runat="server" style="background-color: #99FFCC"/><br />
                ...
                <asp:Label ID="lblEmailError" runat="server" CssClass="pull-right" Text="Die Email wurde bereits nict registriert!" BorderStyle="Inset" Font-Size="Small" ForeColor="red" Visible="False"></asp:Label>
